...
public class ReportController {
    ...
    @PostMapping
    public ResponseEntity<?> report(@RequestBody ReportRequestDto dto, @AuthenticationPrincipal User user){
    ...
    @PutMapping
    public ResponseEntity<?> processReport(@RequestBody ReportProcessRequestDto dto){
